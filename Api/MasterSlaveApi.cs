...
namespace Roslin.Api
{
    public static class MasterSlaveApi
    {
        ...
        public static async Task<ResponseRegisterSubscriber> RegisterSubscriber(IMasterApiContainer masterApiContainer) => await RegisterSubscriber(masterApiContainer.RosMasterUri, masterApiContainer.Topic, masterApiContainer.Type, masterApiContainer.RosNodeUri, masterApiContainer.NodeName);
        ...
        public static async Task<ResponseUnregisterSubscriber> UnregisterSubscriber(IMasterApiContainer masterApiContainer) => await UnregisterSubscriber(masterApiContainer.RosMasterUri, masterApiContainer.Topic, masterApiContainer.RosNodeUri, masterApiContainer.NodeName);
        ...
        public static async Task<ResponseRegisterPublisher> RegisterPublisher(IMasterApiContainer masterApiContainer) => await RegisterPublisher(masterApiContainer.RosMasterUri, masterApiContainer.Topic, masterApiContainer.Type, masterApiContainer.RosNodeUri, masterApiContainer.NodeName);
        ...
        public static async Task<ResponseUnregisterPublisher> UnregisterPublisher(IMasterApiContainer masterApiContainer) => await UnregisterPublisher(masterApiContainer.RosMasterUri, masterApiContainer.Topic, masterApiContainer.RosNodeUri, masterApiContainer.NodeName);
